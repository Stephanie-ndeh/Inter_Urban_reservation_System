   ...
   <footer class="bg-dark text-white pt-5 pb-4">
    <div class="container text-center text-md-left">
        <div class="row text-center text-md-left">
            <div class="col-md-3 col-lg-3 mx-auto mt-3">
                ...
                <p>
                    <a href="#" class="text-white" style="text-decoration: none;">Routes</a>
                </p>
                <p>
                    <a href="#" class="text-white" style="text-decoration: none;">tPrivacy Policy</a>
                </p>
                <p>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <p>
                    <a href="#" class="text-white" style="text-decoration: none;">Ticket Status</a>
                </p>
                <p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p>
                    <i class="fas fa-home mr-3"></i> Douala PK-14
                </p>
                <p>
                    <i class="fas fa-envelope mr-3"></i> Email: Stephaniembusheri@gmail.com
                </p>
                <p>
                    <i class="fas fa-phone mr-3"></i> Phone: +237-651-21-74-28
                </p>
    ...
    <div class="row align-items-center">
        <div class="col-md-7 col-lg-8">
            <p>Copyright © 2023 - 2030 by interUrbanTicketCom.com Privacy Policy All Rights Reserved
                <a href="#" style="text-decoration: none;">
                <strong style="color: #1cafc0;">Company Name</strong></a>
            </p>
        </div>
